...
constexpr auto qt_meta_stringdata_CLASSDialogENDCLASS = QtMocHelpers::stringData(
    "Dialog",
    "on_szumDialog_valueChanged",
    "",
    "arg1",
    "on_ADialog_editingFinished",
    "on_BDialog_editingFinished"
);
...
Q_CONSTINIT const QMetaObject Dialog::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDialogENDCLASS_t,
        ...
        // method 'on_szumDialog_valueChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<double, std::false_type>,
        // method 'on_ADialog_editingFinished'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_BDialog_editingFinished'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_szumDialog_valueChanged((*reinterpret_cast< std::add_pointer_t<double>>(_a[1]))); break;
        case 1: _t->on_ADialog_editingFinished(); break;
        case 2: _t->on_BDialog_editingFinished(); break;
        default: ;
        }
    }
}
